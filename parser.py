...
#Функция возвращает время в минутах и 1, если можно дойти пешком ио 0 - в противно случае
...
for j in range(len(districts)):
    ...
    for i in range(len(links)):
        ...
        #Инициализируем пустой словарь, чтобы в лучае, если мы не найдём какой-то информации по квартире, это поле
